...
import {
  ...
  HiViewColumns,
  HiRectangleGroup,
  HiChatBubbleBottomCenterText,HiEnvelope
...
<div className='border-soild border-l-white border-l-8 border-y-transparent border-y-[6px] border-r-0 absolute -right-2'></div>
</div>
        </div>
        <div>{link.icon}</div>
        </Link>;

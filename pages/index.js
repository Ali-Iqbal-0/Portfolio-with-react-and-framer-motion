  ...
  return (
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
      <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
        <motion.h1 variants={fadeIn('down', 0.2)} initial="hidden" animate='show' exit='hidden' className='h1'>Transforming ideas <br /> Into <span className='text-accent'>Digitial Reality </span></motion.h1>
        ...
        Welcome to Ali's Digital Universe: As a passionate web developer, I'm Ali – your guide to immersive online experiences. Join me in unraveling the art and science of coding.
        </motion.p>

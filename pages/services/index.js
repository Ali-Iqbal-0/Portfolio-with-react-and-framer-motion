      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row gap-x-8'>
          <div className='text-center flex xl:w[30vw] flex-col lg:text-left mb-4 xl:mb-0'>
            ...
            Welcome to my realm of digital craftsmanship. As a web developer, I specialize in creating tailored online experiences that merge elegance with functionality. From captivating designs to seamless code, I offer a range of services to bring your digital aspirations to life. Explore the possibilities and let's collaborate on crafting a digital presence that truly stands out.
            </motion.p>
          </div>
